...
namespace ChocolateFactory.Controllers
{
    public class PersonCreditCardsController : Controller
    {
        ...
        public PersonCreditCardsController(AdventureWorks2022Context context)
        {
            _context = context;
        }
        ...
        {
            var adventureWorks2022Context = _context.PersonCreditCards.Include(p => p.BusinessEntity).Include(p => p.CreditCard);
