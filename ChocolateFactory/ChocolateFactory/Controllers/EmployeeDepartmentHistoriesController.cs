...
namespace ChocolateFactory.Controllers
{
    public class EmployeeDepartmentHistoriesController : Controller
    {
        ...
        public EmployeeDepartmentHistoriesController(AdventureWorks2022Context context)
        {
            _context = context;
        }
        ...
        {
            var adventureWorks2022Context = _context.EmployeeDepartmentHistories.Include(e => e.BusinessEntity).Include(e => e.Department).Include(e => e.Shift);
