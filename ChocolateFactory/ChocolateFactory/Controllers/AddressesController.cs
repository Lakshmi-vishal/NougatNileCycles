...
namespace ChocolateFactory.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(AdventureWorks2022Context context)
        {
            _context = context;
        }
        ...
        {
            var adventureWorks2022Context = _context.Addresses.Include(a => a.StateProvince);
        ...
        public async Task<IActionResult> Create([Bind("AddressId,AddressLine1,AddressLine2,City,StateProvinceId,PostalCode,Rowguid,ModifiedDate")] Address address)
        {
            ...
            ViewData["StateProvinceId"] = new SelectList(_context.StateProvinces, "StateProvinceId", "StateProvinceId", address.StateProvinceId);
            return View(address);
        }
